...
app.get('/getqrcode', utils.isNotLogin, async (req, res, next) => {
    ...
    const data = {
        "RequestURL" : `${req.protocol}://${req.hostname}:${setting.ENFORCE_SOCKET_STANDARD_PORT ? (setting.USE_SSL || setting.ENFORCE_SOCKET_SECURE ? 443 : 80) : setting.PORT}/qrloginapi`,
